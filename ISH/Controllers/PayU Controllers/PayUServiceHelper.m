...
#pragma mark Sandbox Crenditials
    ...
    txnParam.key = @"AwtSpmvG";
    txnParam.merchantid = @"6489139";
    self.payu_salt = @"hmiBsUHd6d";
...
//    [PlugNPlay setDisableWallet:YES];
    ...
    [PlugNPlay setMerchantDisplayName:@"Indian Smart Hub"];
    [PlugNPlay setTopBarColor: [UIColor flatWhiteColor]];
    [PlugNPlay setTopTitleTextColor: [UIColor flatBlackColor]];
    [PlugNPlay setButtonColor:[UIColor flatOrangeColor]];
...
//-(UIColor *)topBarColor = [UIColor blackColor];
//
