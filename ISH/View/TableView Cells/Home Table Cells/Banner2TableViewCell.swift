...
class Banner2TableViewCell: UITableViewCell, FSPagerViewDelegate, FSPagerViewDataSource {
    ...
    private func getData(){
        alamofireRequest(url: "banner_offer.php", params: ["hashkey":AppDelegate.apiKey]) { (json, data) in
